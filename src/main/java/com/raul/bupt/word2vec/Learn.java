package com.raul.bupt.word2vec;
...
import com.raul.bupt.word2vec.domain.HiddenNeuron;
import com.raul.bupt.word2vec.domain.Neuron;
import com.raul.bupt.word2vec.domain.WordNeuron;
import com.raul.bupt.word2vec.util.Haffman;
...
public class Learn {
	...
	public void readVocab(File file) throws IOException {
		...
		for (Entry<String, Integer> element : sort(mc.get())) {
	...
	public  List<Entry<String, Integer>> sort(Map<String,Integer> map) {
		List<Entry<String, Integer>> infoIds = new ArrayList<Entry<String, Integer>>(
