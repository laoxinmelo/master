...
import com.raul.bupt.word2vec.domain.WordEntry;
...
public class Word2VEC {
	...
	public static void main(String[] args) throws IOException {
		...
		// Arrays.toString(com.raul.bupt.word2vec.getWordVector("�й�")));
		// ;
		// System.out.println("ë��" + "\t" +
		// Arrays.toString(com.raul.bupt.word2vec.getWordVector("ë��")));
		// ;
		// System.out.println("����" + "\t" +
		// Arrays.toString(com.raul.bupt.word2vec.getWordVector("����")));
